...
public class PantallaListaTrabajadoresAsisSelect extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantalla_lista_trabajadores_asis_select);
        ...
        adapter = new AdapterListaBuscarTrabajador(PantallaListaTrabajadoresAsisSelect.this);
        ...
        cargarlistaTrabajadoresAsisPorTareo(IDTAREO);
    }

    public void cargarlistaTrabajadoresAsisPorTareo(String idTareo){
        Asistencia objA = new Asistencia();
        objA.obtenerListaTrabajadoresAsistenciaPorTareo(idTareo, "3", "ASC");
        adapter.notifyDataSetChanged();
    }
