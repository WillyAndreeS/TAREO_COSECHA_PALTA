        ...
        public void grabar(String dni){
            if(dni.length() == 8 && MiAplicacionTareo.esNumero(dni)){
                if(IDTAREO == null || IDTAREO.trim().length()==0 || IDTAREO.trim().equalsIgnoreCase("-")){
                    finish();
                    Toast.makeText(ReconocimientoAsistenciaPersonal.this, "No se cargó correctamente el CÓDIGO DE TAREO, por favor ingresa nuevamente al TAREO.", Toast.LENGTH_SHORT).show();
                }else{
                ...
                public void onResponse(String response) {
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            Toast.makeText(ReconocimientoAsistenciaPersonal.this, "ERROR DE CONEXIÓN. Por favor inténtalo nuevamente.", Toast.LENGTH_SHORT).show();
                        }
                    }
            ) {
                @Override
