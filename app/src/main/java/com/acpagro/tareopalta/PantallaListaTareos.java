...
import com.acpagro.tareopalta.adapters.AdapterListaTareos;
import com.acpagro.tareopalta.modelo.Tareo;

public class PantallaListaTareos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Seleccione Tareo (Rend.)");
        ...
        //new TareaCargarListaTareos().execute();
    ...
    private void llenarListView(){
        AdapterListaTareos adapterListaTareos = new AdapterListaTareos(PantallaListaTareos.this);
        lv_tareos.setAdapter(adapterListaTareos);//Se llena el ListView
    }
    ...
    public void dialogAdvertenciaListaVacia(){
        AlertDialog.Builder builder = new AlertDialog.Builder(PantallaListaTareos.this);
        ...
        builder.setPositiveButton("ENTENDIDO", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                finish();
                Intent tareos = new Intent(PantallaListaTareos.this, PantallaTareos.class);
